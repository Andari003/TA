    ...
    public function __invoke():  \Illuminate\Http\JsonResponse
    {
        $data =  json_decode(
            ...
            },
            {
                ...
                "description": "Kenneth can be in the room when Nicki gives birth ... a judge just granted his request to tweak his pre-trial release conditions so he can travel with Nicki. With the courts order in place, KP can travel with Nicki periodically on biz…",
