...
use App\Http\Controllers\GroupEquipmentController;
...
Route::get('/groupequipment/equipment', [GroupEquipmentController::class, 'getEquipment']);
...
Route::get('/groupequipment/user', [GroupEquipmentController::class, 'index']);
Route::get('/equipment/user', [EquipmentController::class, 'index']);
Route::get('/type/user', [TypeController::class, 'index']);
Route::get('/transaksi/user', [TransaksiController::class, 'index']);
...
Route::get('/groupequipment/getOption', [GroupEquipmentController::class, 'GetOptionsResource']);
...
Route::group(['middleware' => 'auth:api'], function () { // auth login di matiin dulu buat test
    ...
    Route::apiResource('/groupequipment', GroupEquipmentController::class);
